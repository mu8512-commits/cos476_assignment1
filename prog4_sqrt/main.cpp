...
// file.cpp → file.o
// main.o + sqrt.o → executable
// extern void sqrtSerial(...); “This function exists somewhere else — trust me.”
// These functions exist in another translation unit (.cpp/.o file).
...
int main() {
    ...
    // no initial guess needed for avx2
    double minAvx2 = 1e30;
    for (int i = 0; i < 3; ++i) {
        double startTime = CycleTimer::currentSeconds();
    ...
    printf("\t\t\t\t(%.2fx speedup from avx2 instrinsics)\n", minSerial/minAvx2);
